...
/**
 * the second custom view demo
 * Created by lihf on 17/2/6.
 */
public class PlayImageActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_image_play);
    ...
    private void initViews() {
       findViewById(R.id.btn_two).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(PlayImageActivity.this, PullChooseActivity.class));
            }
        });
...
//		viewPager.setOffscreenPageLimit(1);// 左右各保留几个对象
    ...
    private void initData() {
        ...
        // 图片资源id数组
        imageResIds = new int[]{R.mipmap.a, R.mipmap.b, R.mipmap.c, R.mipmap.d, R.mipmap.e};
